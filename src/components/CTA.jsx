    ...
    <section id="cta" className="section relative overflow-hidden">
      ...
      <div className="container relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          <a
            href="#"
            className="group relative px-10 py-5 rounded-full bg-gradient-to-r from-[#6c63ff] to-[#3a7bd5] text-white font-semibold text-lg hover:shadow-xl hover:shadow-[#6c63ff]/30 transition-all duration-300 hover:scale-105"
          >
        ...
        >
          {[
            ...
            <div key={stat.label} className="text-center">
              <p className="text-2xl md:text-3xl font-bold text-white mb-1 font-[family-name:var(--font-serif)]">
                {stat.value}
              </p>
