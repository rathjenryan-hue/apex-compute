    ...
    <section id="pricing" className="section relative overflow-hidden">
      ...
      <div className="container relative z-10">
        ...
        <motion.div
          ...
          transition={{ duration: 0.7 }}
          className="max-w-4xl mx-auto rounded-3xl bg-gradient-to-b from-white/[0.04] to-white/[0.01] border border-white/[0.06] p-8 md:p-12"
        >
          {/* Device Selector */}
          <div className="mb-10">
          ...
          {/* Results */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 md:p-8 rounded-2xl bg-black/40 border border-white/5">
            {/* Monthly Payment */}
            <motion.div
            ...
            >
              ...
              <p className="text-2xl md:text-3xl font-bold text-[#8b83ff] mb-1">
          ...
          >
            <a
              href="#cta"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-gradient-to-r from-[#6c63ff] to-[#3a7bd5] text-white font-semibold text-base hover:shadow-lg hover:shadow-[#6c63ff]/30 transition-all duration-300 hover:scale-105"
            >
